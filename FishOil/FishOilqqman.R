...
for (k in suffix) {
    ...
    for (j in exposures) {
      ...
      infileall <- as_tibble(read.table(paste("/scratch/ahc87874/FishOil/Combined/", i, "x", j, k, "alltab.txt", sep = ""), 
      ...
      png(filename = paste(outdirman, i, "x", j, k, "man.png", sep = ""), type = "cairo", width = 1200, height = 600)
      ...
      png(filename = paste(outdirqq, i, "x", j, k, "qq.png", sep = ""), type = "cairo", width = 600, height = 600)
