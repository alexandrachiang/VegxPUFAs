...
for (i in phenos) {
	...
	SNPs <- "rs34249205"
      ...
      png(filename = paste(outdirman, "FINAL", i, "man.png", sep = ""), type = "cairo", width = 1300, height = 1000)
      ...
      if (i == "w3FA_NMR_TFAP") {
        ...
        png(filename = paste(outdirmagma, i, "MAGMA.png", sep = ""), type = "cairo", width = 1300, height = 1000)
