...
infileallRepli <- as_tibble(read.table(paste("/scratch/ahc87874/Replication/CombinedCSA/", pheno, "x", exposure, "alltab.txt", sep = ""), 
                                          header = TRUE, stringsAsFactors = FALSE))
infileall <- as_tibble(read.table(paste("/scratch/ahc87874/Fall2022/CombinedAllCol/", pheno, "x", exposure, "wKeep", "alltab.txt", sep = ""), 
                                          header = TRUE, stringsAsFactors = FALSE))
