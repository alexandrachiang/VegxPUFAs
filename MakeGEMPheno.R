...
GEMpheno <- ukbSSRV %>% select(FID, IID, 
                               ...
                               contains("genetic_principal_components_f22009_0_"), body_mass_index_f21001_0_0, 
