...
#SBATCH --job-name=vQTLFlignerKilleen
#SBATCH --ntasks=16
#SBATCH --nodes=1
#SBATCH --time=70:00:00
#SBATCH --mem=500000
#SBATCH --output=vQTLFlignerKilleen.%j.out
#SBATCH --error=vQTLFlignerKilleen.%j.err
...
outdir=("/scratch/ahc87874/Fall2022/vQTL/FlignerKilleen")
mkdir -p outdir
...
--vqtl-mtd 3 \
--thread-num 20 \
--out $outdir/vQTL_FlignerKilleen_chr"$i"_"$j"
